...
<script>
	$(function(){
		...
		var performanceSlider = new SCarousel( "#performance-detail-wrapper .performance-slider", {
			style: {
				parentHeight: true,
...
<style>
	.mobile #performance-detail-wrapper .carousel .dots{ bottom:0px;}
	#performance-detail-wrapper .carousel .dots{ text-align:center; }
...
<div style="border:1px solid #999;position:relative;" id="performance-detail-wrapper">
