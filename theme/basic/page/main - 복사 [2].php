...
<style>
	...
	#estimate-tabs { position: absolute; top:-50px; z-index: 100;}
	#estimate-tabs a { display: block; background: #716b6d; height:50px; width:190px; line-height:50px; text-align: center; font-size: 1.3em; max-width: 33.33%; transition-duration: 0.3s;}

	.mobile #estimate-tabs a { width:170px; }
	.mobile .carousel .dots{ bottom: 50px; }
	#estimate-tabs a:hover { text-decoration: none; color: inherit; }
	#estimate-tabs a.active{background: #85bee6; }

	#section-estimate .estimate-group{ display: none; background: #8abbe4; }

	#section-estimate .estimate-group .fl.w-12-4{ padding: 20px 0; position: relative; }
	#section-estimate .estimate-group .title{ font-size:1.2em;; }
...
<div id=section-estimate class="wrapper">
	<div class="row">
		    ...
		    <style>
				...
				.information{background:#0f5e9a !important;  }
				...
				.information .consulting-div{background: #ff9932; text-align: center; position: absolute; width: 100%; line-height: 72px; }
				...
				.estimate-select{ position: relative;  }
				.estimate-select .label{  }
				.estimate-select .label span{  display:block; border:1px solid #eee; text-align: center; line-height: 40px; }

				.estimate-select.white{ background: #fff;   }
				.estimate-select.white .label span{ color: #8abbe4; }


				.estimate-select ul{ position:absolute; width:100%; display:none; z-index: 1; }
				.estimate-select ul li{ background:#8abbe4 }
				.estimate-select ul li span{ display:block; border:1px solid #eee; border-top:0px; text-align: center;  }
				.estimate-select select{ display:none;}

				.mobile #section-estimate .w-12-6 {width: 50%;}
            </style>
            ...
            <div class="estimate-group">
                <div class="w-12-4 fl">
					...
					<!-- for estimate radio -->
					<style>
						.estimate-radio label{ display:block; line-height: 40px; transition-duration:0.2s; }
						.estimate-radio label span{ display:block; border:1px solid #fff; text-align: center; }
						.estimate-radio label.active{ background: #fff; color: #8abbe4; }
						.estimate-radio label input{ display: none; }

						#section-estimate .estimate-radio .clear{ height:15px; }
					</style>
						...
						$(function(){
							...
							$(".estimate-radio").each(function(){
								...
								$(this).find( "input" ).click(function(){
									...
									$(this).closest('.estimate-radio').find('.active').removeClass('active');
                    ...
                    <div class="scene-div im-x">
                        ...
                        <div class="estimate-radio">
                        	<label class="w-12-6 fl"><span>천장시공 포함</span><input type="radio" name="w-ceiling" value="있음"/></label>
                        	<label class="w-12-6 fl"><span>천장시공 미포함</span><input type="radio" name="w-ceiling" value="없음"/></label>
							<div class="clear"></div>
                        </div>

                        <div class="estimate-radio">
                        	<label class="w-12-6 fl"><span>거주중/가구있음</span><input type="radio" name="w-stay" value="있음"/></label>
                        	<label class="w-12-6 fl"><span>빈집/가구없음</span><input type="radio" name="w-stay" value="없음"/></label>
							<div class="clear"></div>
                        </div>
				...
				<div class="w-12-4 fl">
                    <div class="im-x">
                        ...
                        <div class="estimate-radio">
                        	<label class="w-12-6 fl"><span>시크도배</span><input type="radio" name="w-papering" value="시크도배"/></label>
		...
		<input type="hidden" name="option-area" value="" />
		<input type="hidden" name="type" value="floorpaper"/>
			<div class="estimate-group">
                <div class="w-12-4 fl">
                    <div class="im-x">
                        <div class="title">집 전체 면적</div>
                    ...
                    <div class="scene-div im-x">
						...
						<div class="estimate-radio">
                        	<label class="w-12-6 fl"><span>집 전체 포함</span><input type="radio" name="p-all" value="있음"/></label>
                        	<label class="w-12-6 fl"><span>방 만 시공</span><input type="radio" name="p-all" value="없음"/></label>
							<div class="clear"></div>
                        </div>

						<div class="estimate-radio">
                        	<label class="w-12-6 fl"><span>거주중/가구있음</span><input type="radio" name="p-stay" value="있음"/></label>
                        	<label class="w-12-6 fl"><span>빈집/가구 없음</span><input type="radio" name="p-stay" value="없음"/></label>
							<div class="clear"></div>
                        </div>
                        <div class="clear"></div>
                    </div>
			...
			<div class="estimate-group">
                <div class="w-12-4 fl">
                    ...
                    <div class="scene-div im-x">
						...
						<div class="estimate-radio">
                        	<label class="w-12-6 fl"><span>기존바닥재 없음/장판</span><input type="radio" name="f-existing" value="있음"/></label>
                        	<label class="w-12-6 fl"><span>기존바닥재 마루/대리석</span><input type="radio" name="f-existing" value="없음"/></label>
							<div class="clear"></div>
                        </div>

						<div class="estimate-radio">
                        	<label class="w-12-6 fl"><span>거주중/가구있음</span><input type="radio" name="f-stay" value="있음"/></label>
                        	<label class="w-12-6 fl"><span>빈집/가구 없음</span><input type="radio" name="f-stay" value="없음"/></label>
							<div class="clear"></div>
                        </div>
                        <div class="clear"></div>
                    </div>
